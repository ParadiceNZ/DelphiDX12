...
// Note 2025: removed "obsolute" enumerations, since they trigger FPC compiler notes.

{$IFDEF FPC}
{$MODE delphi}{$H+}
{$warn 3057 off}  // Disable "An inherited method is hidden" warning for interfaces
{$ENDIF}
